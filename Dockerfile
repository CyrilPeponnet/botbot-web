...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y python python-pip python-dev \
    ...
    libpq-dev libjpeg8-dev zlib1g-dev libfreetype6-dev liblcms2-dev postgresql-client
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y curl gunicorn default-jre
